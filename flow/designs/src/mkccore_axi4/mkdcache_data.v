...
//
// On Thu Jul 31 12:54:44 CST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mkdcache_data(CLK,
  ...
  wire [511 : 0] IF_mv_line_select_wayselect_BIT_2_77_THEN_v_da_ETC___d190,
		 lv_selected_line__h21918,
		 lv_selected_line__h21950,
		 lv_selected_line__h21982,
		 lv_selected_line__h22014,
		 x__h18881,
		 x__h19571,
		 x__h20260,
		 x__h20949;
  wire [8 : 0] block_offset__h18787;
  wire [2 : 0] x__h18569,
	       x__h18581,
	       x__h18593,
	       x__h21644,
  ...
  assign mv_word_select =
	     mv_word_select_wayselect[3] ?
	       { x__h18881[63:0], lv_selected_line__h21918 } :
	       IF_mv_word_select_wayselect_BIT_2_00_THEN_v_da_ETC___d174 ;
  ...
  bram_1rw_64x64_wrapper #(.ADDR_WIDTH(32'd6),
	     .DATA_WIDTH(32'd64),
  ...
  assign IF_mv_word_select_wayselect_BIT_1_03_THEN_v_da_ETC___d173 =
	     mv_word_select_wayselect[1] ?
	       { x__h20260[63:0], lv_selected_line__h21982 } :
	       { x__h20949[63:0], lv_selected_line__h22014 } ;
  assign IF_mv_word_select_wayselect_BIT_2_00_THEN_v_da_ETC___d174 =
	     mv_word_select_wayselect[2] ?
	       { x__h19571[63:0], lv_selected_line__h21950 } :
  ...
  assign NOT_0_CONCAT_mv_word_select_wayselect_BIT_3_8__ETC___d110 =
	     x__h18569 + y__h18570 > 3'd1 ;
  assign block_offset__h18787 = { mv_word_select_blocknum, 6'd0 } ;
  assign lv_selected_line__h21918 =
  ...
  assign lv_selected_line__h21950 =
  ...
  assign lv_selected_line__h21982 =
  ...
  assign lv_selected_line__h22014 =
  ...
  assign x__h18569 = x__h18581 + y__h18582 ;
  assign x__h18581 = x__h18593 + y__h18594 ;
  assign x__h18593 = { 2'd0, mv_word_select_wayselect[3] } ;
  assign x__h18881 = lv_selected_line__h21918 >> block_offset__h18787 ;
  assign x__h19571 = lv_selected_line__h21950 >> block_offset__h18787 ;
  assign x__h20260 = lv_selected_line__h21982 >> block_offset__h18787 ;
  assign x__h20949 = lv_selected_line__h22014 >> block_offset__h18787 ;
  assign x__h21644 = x__h21656 + y__h21657 ;
  assign x__h21656 = x__h21668 + y__h21669 ;
  assign x__h21668 = { 2'd0, mv_line_select_wayselect[3] } ;
  assign y__h18570 = { 2'd0, mv_word_select_wayselect[0] } ;
  assign y__h18582 = { 2'd0, mv_word_select_wayselect[1] } ;
  assign y__h18594 = { 2'd0, mv_word_select_wayselect[2] } ;
  assign y__h21645 = { 2'd0, mv_line_select_wayselect[0] } ;
  assign y__h21657 = { 2'd0, mv_line_select_wayselect[1] } ;
  assign y__h21669 = { 2'd0, mv_line_select_wayselect[2] } ;
  ...
  begin
	...
	$finish(32'd0);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_mv_line_select && x__h21644 + y__h21645 != 3'd1)
	$display("Dynamic assertion failed: \"caches_mmu/src/dcache/dcache_lib.bsv\", line 649, column 45\nWayselect should be one-hot.");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_mv_line_select && x__h21644 + y__h21645 != 3'd1) $finish(32'd0);
  end
  // synopsys translate_on
