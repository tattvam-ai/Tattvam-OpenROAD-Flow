...
// mv_tagmatch_resp               O     4
// RDY_mv_tagmatch_resp           O     1 const
// mv_tag_select                  O    32
// RDY_mv_tag_select              O     1 const
// CLK                            I     1 clock
// RST_N                          I     1 reset
...
// ma_request_way                 I     2
// mv_tagmatch_resp_address_in    I    32
// mv_tag_select_wayselect        I     2
// EN_ma_request                  I     1
//
// Combinational paths from inputs to outputs:
//   mv_tagmatch_resp_address_in -> mv_tagmatch_resp
//   mv_tag_select_wayselect -> mv_tag_select
//
//
...
module mkdcache_tag(CLK,
		    ...
		    mv_tagmatch_resp_address_in,
		    mv_tagmatch_resp,
		    RDY_mv_tagmatch_resp,

		    mv_tag_select_wayselect,
		    mv_tag_select,
		    RDY_mv_tag_select);
  ...
  // value method mv_tagmatch_resp
  input  [31 : 0] mv_tagmatch_resp_address_in;
  output [3 : 0] mv_tagmatch_resp;
  output RDY_mv_tagmatch_resp;

  // value method mv_tag_select
  input  [1 : 0] mv_tag_select_wayselect;
  output [31 : 0] mv_tag_select;
  output RDY_mv_tag_select;

  // signals for module outputs
  wire [31 : 0] mv_tag_select;
  wire [3 : 0] mv_tagmatch_resp;
  wire RDY_ma_request, RDY_mv_tag_select, RDY_mv_tagmatch_resp;
  ...
  reg [19 : 0] SEL_ARR_v_tags_0_rg_output_0_port1__read__2_v__ETC___d28;
  wire [3 : 0] IF_v_tags_0_ram_single_0douta_EQ_mv_tagmatch__ETC__q1;
  wire [1 : 0] v_tags_1_rg_output_0_port1__read__0_EQ_mv_tagm_ETC___d26;
  ...
  // value method mv_tagmatch_resp
  assign mv_tagmatch_resp =
	     { v_tags_3_ram_single_0_douta ==
	       mv_tagmatch_resp_address_in[31:12],
	       v_tags_2_ram_single_0_douta ==
	       mv_tagmatch_resp_address_in[31:12],
	       v_tags_1_rg_output_0_port1__read__0_EQ_mv_tagm_ETC___d26 } ;
  assign RDY_mv_tagmatch_resp = 1'd1 ;

  // value method mv_tag_select
  assign mv_tag_select =
	     { SEL_ARR_v_tags_0_rg_output_0_port1__read__2_v__ETC___d28,
	       12'd0 } ;
  assign RDY_mv_tag_select = 1'd1 ;

  // submodule v_tags_0_ram_single_0
  bram_1rw_64x20_wrapper #(.ADDR_WIDTH(32'd6),
	     .DATA_WIDTH(32'd20),
  ...
  // remaining internal signals
  assign IF_v_tags_0_ram_single_0douta_EQ_mv_tagmatch__ETC__q1 =
	     (v_tags_0_ram_single_0_douta ==
	      mv_tagmatch_resp_address_in[31:12]) ?
	       4'd1 :
	       4'd0 ;
  assign v_tags_1_rg_output_0_port1__read__0_EQ_mv_tagm_ETC___d26 =
	     { v_tags_1_ram_single_0_douta ==
	       mv_tagmatch_resp_address_in[31:12],
	       IF_v_tags_0_ram_single_0douta_EQ_mv_tagmatch__ETC__q1[0] } ;
  always@(mv_tag_select_wayselect or
	  v_tags_0_ram_single_0_douta or
	  v_tags_1_ram_single_0_douta or
	  v_tags_2_ram_single_0_douta or v_tags_3_ram_single_0_douta)
  begin
    case (mv_tag_select_wayselect)
      2'd0:
	  SEL_ARR_v_tags_0_rg_output_0_port1__read__2_v__ETC___d28 =
	      v_tags_0_ram_single_0_douta;
      2'd1:
