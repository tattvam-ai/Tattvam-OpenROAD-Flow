...
module mksign_dump(CLK,
  ...
  // remaining internal signals
  assign lv_shift__h2584 = { ff_lower_order_bits_D_OUT, 3'd0 } ;
  assign m_xactor_f_rd_dataD_OUT_BITS_68_TO_5_SRL_lv_s_ETC__q3 =
	     m_xactor_f_rd_data_D_OUT[68:5] >> lv_shift__h2584 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[70:69] != 2'd0)
	$display(v__h2864, "\tSIGNATUREDUMP got Bus Error");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[70:69] != 2'd0)
	$finish(32'd0);
